...
struct PredatorDetail2: View {
    let predator: ApexPredetaor
    var body: some View {
        ScrollView{
            // same as PredatorDetail but with the use of a Zstack instead of VStack
            ZStack{
...
struct PredatorDetail2_Previews: PreviewProvider {
    static var previews: some View {
        ...
        PredatorDetail2(predator: predator)
